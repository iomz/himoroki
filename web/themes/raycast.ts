...
export const raycastTheme = {
  ...
  light: {
    ...
    accent: '#df4147', accentSoft: '#f9dfe0', accentText: '#91282c',
    ...
    successSurface: '#e3eee6', successText: '#2d613d', dangerSurface: '#f7dcdc', dangerText: '#86262a',
  },
  dark: {
    ...
    accent: '#ff6368', accentSoft: '#4a2225', accentText: '#ffc5c7',
    ...
    successSurface: '#213a29', successText: '#a9ddb8', dangerSurface: '#4c2326', dangerText: '#ffc2c5',
  },
